...
public abstract class WebAppClassPathFinder extends BaseClassPathFinder {

	protected String appName;

	public WebAppClassPathFinder(String appName) {
	...
	protected String getClassPath() {
		...
		if (classesLocation != null) {
			...
			String libsLocationPath = URLDecoder.decode(classesLocationPath + "../" + appName + "/WEB-INF/lib/");
